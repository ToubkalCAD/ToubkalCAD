...
__webpack_require__.add({
    ...
    "./node_modules/.pnpm/@jsonjoy.com+base64@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/base64/lib/createFromBase64Bin.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        const constants_1 = __webpack_require__("./node_modules/.pnpm/@jsonjoy.com+base64@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/base64/lib/constants.js");
        const createFromBase64Bin = (chars = constants_1.alphabet, pad = '=')=>{
            if (64 !== chars.length) throw new Error('chars must be 64 characters long');
            let max = 0;
            for(let i = 0; i < chars.length; i++)max = Math.max(max, chars.charCodeAt(i));
            const table = [];
            for(let i = 0; i <= max; i += 1)table[i] = -1;
            for(let i = 0; i < chars.length; i++)table[chars.charCodeAt(i)] = i;
            const doExpectPadding = 1 === pad.length;
    ...
    "./node_modules/.pnpm/@jsonjoy.com+base64@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/base64/lib/createToBase64Bin.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        const createToBase64Bin = (chars = constants_1.alphabet, pad = '=')=>{
            ...
            const doAddPadding = 1 === pad.length;
    ...
    "./node_modules/.pnpm/@jsonjoy.com+base64@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/base64/lib/fromBase64Bin.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        const createFromBase64Bin_1 = __webpack_require__("./node_modules/.pnpm/@jsonjoy.com+base64@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/base64/lib/createFromBase64Bin.js");
    ...
    "./node_modules/.pnpm/@jsonjoy.com+base64@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/base64/lib/toBase64Bin.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        const createToBase64Bin_1 = __webpack_require__("./node_modules/.pnpm/@jsonjoy.com+base64@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/base64/lib/createToBase64Bin.js");
    ...
    "./node_modules/.pnpm/@jsonjoy.com+buffers@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/buffers/lib/Reader.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        class Reader {
            ...
            subarray(start = 0, end) {
                ...
                const actualEnd = 'number' == typeof end ? x + end : this.end;
    ...
    "./node_modules/.pnpm/@jsonjoy.com+buffers@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/buffers/lib/Writer.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        const Slice_1 = __webpack_require__("./node_modules/.pnpm/@jsonjoy.com+buffers@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/buffers/lib/Slice.js");
        const EMPTY_UINT8 = new Uint8Array([]);
        const EMPTY_VIEW = new DataView(EMPTY_UINT8.buffer);
        const hasBuffer = 'function' == typeof Buffer;
        const utf8Write = hasBuffer ? Buffer.prototype.utf8Write : null;
        const from = hasBuffer ? Buffer.from : null;
        const textEncoder = "u" > typeof TextEncoder ? new TextEncoder() : null;
        class Writer {
            ...
            utf8(str) {
                const theoreticalMaxLength = 4 * str.length;
                    ...
                    if ((0xfffff800 & value) === 0) uint8[offset++] = value >> 6 & 0x1f | 0xc0;
                        ...
                        if (value >= 0xd800 && value <= 0xdbff) {
                            if (pos < length) {
                                ...
                                if ((0xfc00 & extra) === 0xdc00) {
                                    pos++;
                                    value = ((0x3ff & value) << 10) + (0x3ff & extra) + 0x10000;
                                }
                            }
                        }
    ...
    "./node_modules/.pnpm/@jsonjoy.com+buffers@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/buffers/lib/f16.js" (__unused_rspack_module, exports) {
        ...
        const decodeF16 = (binary)=>{
            const exponent = (0x7c00 & binary) >> 10;
            const fraction = 0x03ff & binary;
    ...
    "./node_modules/.pnpm/@jsonjoy.com+buffers@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/buffers/lib/utf8/CachedUtf8Decoder.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        const v10_1 = tslib_1.__importDefault(__webpack_require__("./node_modules/.pnpm/@jsonjoy.com+buffers@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/buffers/lib/utf8/decodeUtf8/v10.js"));
        let x = 1 + Math.round(4294967294 * Math.random());
        ...
        class CachedUtf8Decoder {
            ...
            store(bytes, value) {
                ...
                if (length >= 16) records[randomU32(0, 15)] = record;
    ...
    "./node_modules/.pnpm/@jsonjoy.com+buffers@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/buffers/lib/utf8/decodeUtf8/index.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        const tslib_1 = __webpack_require__("./node_modules/.pnpm/tslib@2.8.1/node_modules/tslib/tslib.es6.mjs");
        const v16_1 = tslib_1.__importDefault(__webpack_require__("./node_modules/.pnpm/@jsonjoy.com+buffers@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/buffers/lib/utf8/decodeUtf8/v16.js"));
    ...
    "./node_modules/.pnpm/@jsonjoy.com+buffers@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/buffers/lib/utf8/decodeUtf8/v10.js" (__unused_rspack_module, exports) {
        ...
        exports["default"] = (buf, start, length)=>{
            ...
            while(offset < end){
                ...
                const octet2 = 0x3f & buf[offset++];
                if ((0xe0 & octet1) === 0xc0) {
                    str += fromCharCode((0x1f & octet1) << 6 | octet2);
                    continue;
                }
                const octet3 = 0x3f & buf[offset++];
                if ((0xf0 & octet1) === 0xe0) {
                    str += fromCharCode((0x1f & octet1) << 12 | octet2 << 6 | octet3);
                    continue;
                }
                if ((0xf8 & octet1) === 0xf0) {
                    const octet4 = 0x3f & buf[offset++];
                    let unit = (0x07 & octet1) << 0x12 | octet2 << 0x0c | octet3 << 0x06 | octet4;
                    if (unit > 0xffff) {
                        unit -= 0x10000;
                        const unit0 = unit >>> 10 & 0x3ff | 0xd800;
                        unit = 0xdc00 | 0x3ff & unit;
    ...
    "./node_modules/.pnpm/@jsonjoy.com+buffers@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/buffers/lib/utf8/decodeUtf8/v16.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        const tslib_1 = __webpack_require__("./node_modules/.pnpm/tslib@2.8.1/node_modules/tslib/tslib.es6.mjs");
        const decodeAscii_1 = __webpack_require__("./node_modules/.pnpm/@jsonjoy.com+buffers@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/buffers/lib/utf8/decodeAscii.js");
        const v18_1 = tslib_1.__importDefault(__webpack_require__("./node_modules/.pnpm/@jsonjoy.com+buffers@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/buffers/lib/utf8/decodeUtf8/v18.js"));
        const hasBuffer = "u" > typeof Buffer;
                ...
                if ((0x80 & code) !== 0) {
                    ...
                    if ((0xe0 & code) === 0xc0) code = (0x1f & code) << 6 | octet2;
                        ...
                        if ((0xf0 & code) === 0xe0) code = (0x1f & code) << 12 | octet2 << 6 | octet3;
                            ...
                            const octet4 = 0x3f & buf[offset++];
                            let unit = (0x07 & code) << 0x12 | octet2 << 0x0c | octet3 << 0x06 | octet4;
                            if (unit > 0xffff) {
                                unit -= 0x10000;
                                const unit0 = unit >>> 10 & 0x3ff | 0xd800;
                                code = 0xdc00 | 0x3ff & unit;
                                points.push(unit0);
                            } else code = unit;
                        }
                    }
    ...
    "./node_modules/.pnpm/@jsonjoy.com+fs-core@4.57.2_tslib@2.8.1/node_modules/@jsonjoy.com/fs-core/lib/File.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        class File {
            ...
            write(buf, offset = 0, length = buf.length, position) {
                if ('number' != typeof position) position = this.position;
    ...
    "./node_modules/.pnpm/@jsonjoy.com+fs-core@4.57.2_tslib@2.8.1/node_modules/@jsonjoy.com/fs-core/lib/Link.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        class Link {
            ...
            set steps(val) {
                this._steps = val;
                for (const [child, link] of this.children.entries())if ('.' !== child && '..' !== child) link?.syncSteps();
            }
    ...
    "./node_modules/.pnpm/@jsonjoy.com+fs-core@4.57.2_tslib@2.8.1/node_modules/@jsonjoy.com/fs-core/lib/Node.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        class Node {
            ...
            canRead(uid = getuid(), gid = getgid()) {
                if (4 & this.perm) return true;
                if (gid === this.gid) {
                    if (32 & this.perm) return true;
                }
                if (uid === this.uid) {
                    if (256 & this.perm) return true;
                }
                return false;
            }
            canWrite(uid = getuid(), gid = getgid()) {
                if (2 & this.perm) return true;
                if (gid === this.gid) {
                    if (16 & this.perm) return true;
                }
                if (uid === this.uid) {
                    if (128 & this.perm) return true;
                }
                return false;
            }
            canExecute(uid = getuid(), gid = getgid()) {
                if (1 & this.perm) return true;
                if (gid === this.gid) {
                    if (8 & this.perm) return true;
                }
                if (uid === this.uid) {
                    if (64 & this.perm) return true;
                }
                return false;
            }
            del() {
        ...
        class Superblock {
            ...
            constructor(opts = {}){
                ...
                this.writeFile = (id, buf, flagsNum, modeNum)=>{
                    const isUserFd = 'number' == typeof id;
                    let fd;
                    ...
                    try {
                        while(length > 0){
                            ...
                            offset += written;
                            length -= written;
                            if (void 0 !== position) position += written;
                        }
                    } finally{
            ...
            walk(stepsOrFilenameOrLink, resolveSymlinks = false, checkExistence = false, checkAccess = false, funcName) {
                ...
                } else if ('string' == typeof stepsOrFilenameOrLink) {
            ...
            fromJSON(json, cwd = this.process.cwd()) {
                for(let filename in json){
                    ...
                    if ('string' == typeof data || data instanceof buffer_1.Buffer) {
            ...
            reset() {
                ...
                this.root.setNode(this.createNode(511 | fs_node_utils_1.constants.S_IFDIR));
            }
        ...
        const flattenJSON = (nestedJSON)=>{
            ...
            function flatten(pathPrefix, node) {
                for(const path in node){
                    ...
                    if ('string' == typeof contentOrNode || contentOrNode instanceof buffer_1.Buffer) flatJSON[joinedPath] = contentOrNode;
                    else if ('object' != typeof contentOrNode || null === contentOrNode || contentOrNode instanceof buffer_1.Buffer || !(Object.keys(contentOrNode).length > 0)) flatJSON[joinedPath] = null;
                    else flatten(joinedPath, contentOrNode);
                }
            }
            flatten('', nestedJSON);
            return flatJSON;
    ...
    "./node_modules/.pnpm/@jsonjoy.com+fs-core@4.57.2_tslib@2.8.1/node_modules/@jsonjoy.com/fs-core/lib/util.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        const normalizePath = (str, stripTrailing)=>{
            ...
            str = str.replace(/[\\\/]+/g, '/');
            if (false !== stripTrailing) str = removeTrailingSeparator(str);
            return str;
        };
        ...
        function dataToBuffer(data, encoding = encoding_1.ENCODING_UTF8) {
            ...
            if (data instanceof Uint8Array) return (0, buffer_1.bufferFrom)(data);
            if ('buffer' === encoding) return (0, buffer_1.bufferFrom)(String(data), 'utf8');
        ...
        function nullCheck(path, callback) {
            if (-1 !== ('' + path).indexOf('\u0000')) {
                ...
                er.code = 'ENOENT';
                if ('function' != typeof callback) throw er;
        ...
        function getPathFromURLPosix(url) {
            ...
            for(let n = 0; n < pathname.length; n++)if ('%' === pathname[n]) {
                const third = 0x20 | pathname.codePointAt(n + 2);
        ...
        function pathToFilename(path) {
            ...
            if ('string' != typeof path && !buffer_1.Buffer.isBuffer(path)) {
                try {
                    if (!(path instanceof __webpack_require__("url").URL)) throw new TypeError(fs_node_utils_1.ERRSTR.PATH_STR);
                } catch (err) {
    ...
    "./node_modules/.pnpm/@jsonjoy.com+fs-node-builtins@4.57.2_tslib@2.8.1/node_modules/@jsonjoy.com/fs-node-builtins/lib/internal/errors.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        function message(key, args) {
            ...
            if ('function' == typeof msg) fmt = msg;
                ...
                fmt = util_1.format;
                if (void 0 === args || 0 === args.length) return msg;
                args.unshift(msg);
            }
        ...
        E('ERR_INVALID_OPT_VALUE', (name, value)=>`The value "${String(value)}" is invalid for option "${name}"`);
    ...
    "./node_modules/.pnpm/@jsonjoy.com+fs-node-builtins@4.57.2_tslib@2.8.1/node_modules/@jsonjoy.com/fs-node-builtins/lib/util.js" (__unused_rspack_module, exports) {
        ...
        function inherits(ctor, superCtor) {
            if (null == ctor) throw new TypeError('The constructor to inherit from is not defined');
            if (null == superCtor) throw new TypeError('The super constructor to inherit from is not defined');
    ...
    "./node_modules/.pnpm/@jsonjoy.com+fs-node@4.57.2_tslib@2.8.1/node_modules/@jsonjoy.com/fs-node/lib/Dir.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        class Dir {
            ...
            close(callback) {
                ...
                if (this.closed) return void process.nextTick(callback, new errors.Error('ERR_DIR_CLOSED'));
    ...
    "./node_modules/.pnpm/@jsonjoy.com+fs-node@4.57.2_tslib@2.8.1/node_modules/@jsonjoy.com/fs-node/lib/FileHandle.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        class FileHandle extends events_1.EventEmitter {
            ...
            readableWebStream(options = {}) {
                ...
                let position = 0;
                if (-1 === this.fd) throw new Error('The FileHandle is closed');
            ...
            async read(buffer, offset, length, position) {
                const readPosition = null != position ? position : this.position;
                const result = await (0, util_1.promisify)(this.fs, 'read', (bytesRead)=>({
                        bytesRead,
                        buffer
                    }))(this.fd, buffer, offset, length, readPosition);
                if (null == position) this.position += result.bytesRead;
                return result;
            }
            ...
            async write(buffer, offset, length, position) {
                const useInternalPosition = 'number' != typeof position;
    ...
    "./node_modules/.pnpm/@jsonjoy.com+fs-node@4.57.2_tslib@2.8.1/node_modules/@jsonjoy.com/fs-node/lib/FsPromises.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        class FsPromises {
            constructor(fs, FileHandle){
                ...
                this.readFile = (id, options)=>(0, util_1.promisify)(this.fs, 'readFile')(id instanceof this.FileHandle ? id.fd : id, options);
                this.appendFile = (path, data, options)=>(0, util_1.promisify)(this.fs, 'appendFile')(path instanceof this.FileHandle ? path.fd : path, data, options);
                this.open = (path, flags = 'r', mode)=>(0, util_1.promisify)(this.fs, 'open', (fd)=>new this.FileHandle(this.fs, fd))(path, flags, mode);
                ...
                this.watch = (filename, options)=>{
                    const watchOptions = 'string' == typeof options ? {
                        encoding: options
                    } : options || {};
    ...
    "./node_modules/.pnpm/@jsonjoy.com+fs-node@4.57.2_tslib@2.8.1/node_modules/@jsonjoy.com/fs-node/lib/StatFs.js" (__unused_rspack_module, exports) {
        ...
        class StatFs {
            static build(superblock, bigint = false) {
                ...
                const getStatNumber = bigint ? (number)=>BigInt(number) : (number)=>number;
                ...
                const usedBlocks = Math.min(2 * totalInodes, totalBlocks);
    ...
    "./node_modules/.pnpm/@jsonjoy.com+fs-node@4.57.2_tslib@2.8.1/node_modules/@jsonjoy.com/fs-node/lib/glob.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        function isExcluded(path, exclude) {
            ...
            if ('function' == typeof exclude) return exclude(path);
    ...
    "./node_modules/.pnpm/@jsonjoy.com+fs-node@4.57.2_tslib@2.8.1/node_modules/@jsonjoy.com/fs-node/lib/options.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        const getMkdirOptions = (options)=>{
            if ('number' == typeof options) return Object.assign({}, mkdirDefaults, {
                mode: options
            });
        ...
        function getOptions(defaults, options) {
            ...
            if ('buffer' !== opts.encoding) (0, fs_node_utils_1.assertEncoding)(opts.encoding);
            return opts;
        }
    ...
    "./node_modules/.pnpm/@jsonjoy.com+fs-node@4.57.2_tslib@2.8.1/node_modules/@jsonjoy.com/fs-node/lib/util.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        function _modeToNumber(mode, def) {
            if ('number' == typeof mode) return mode;
            if ('string' == typeof mode) return parseInt(mode, 8);
            if (def) return modeToNumber(def);
        }
        function modeToNumber(mode, def) {
            const result = _modeToNumber(mode, def);
            if ('number' != typeof result || isNaN(result)) throw new TypeError(fs_node_utils_1.ERRSTR.MODE_INT);
            return result;
        }
        function nullCheck(path, callback) {
            if (-1 !== ('' + path).indexOf('\u0000')) {
        ...
        const getWriteArgs = (fd, a, b, c, d, e)=>{
            ...
            const tipc = typeof c;
            const tipd = typeof d;
            if ('string' !== tipa) if ('function' === tipb) callback = b;
            else if ('function' === tipc) {
                offset = 0 | b;
                callback = c;
            } else if ('function' === tipd) {
                offset = 0 | b;
                length = c;
                callback = d;
            } else {
            ...
            else if ('function' === tipb) callback = b;
            else if ('function' === tipc) {
                position = b;
                callback = c;
            } else if ('function' === tipd) {
            ...
            if ('string' !== tipa) {
                if (void 0 === length) length = buf.length;
            } else {
                offset = 0;
                length = buf.length;
            }
        ...
        const getWriteSyncArgs = (fd, a, b, c, d)=>{
            ...
            let length;
            let position;
            const isBuffer = 'string' != typeof a;
            if (isBuffer) {
                offset = 0 | (b || 0);
                length = c;
                position = d;
        ...
        function bufferToEncoding(buffer, encoding) {
            if (!encoding || 'buffer' === encoding) return buffer;
    ...
    "./node_modules/.pnpm/@jsonjoy.com+fs-node@4.57.2_tslib@2.8.1/node_modules/@jsonjoy.com/fs-node/lib/volume.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        function dataToStr(data, encoding = fs_node_utils_1.ENCODING_UTF8) {
            ...
            if (data instanceof Uint8Array) return (0, buffer_1.bufferFrom)(data).toString(encoding);
            return String(data);
        }
        ...
        class Volume {
            ...
            constructor(_core = new fs_core_1.Superblock()){
                ...
                this.read = (fd, buffer, offset, length, position, callback)=>{
                    ...
                    if (0 === length) return queueMicrotask(()=>{
                ...
                this.readv = (fd, buffers, a, b)=>{
                    let position = a;
                    let callback = b;
                    if ('function' == typeof a) [position, callback] = [
                        null,
                        a
                    ];
                    (0, util_3.validateCallback)(callback);
                ...
                this.writeFile = (id, data, a, b)=>{
                    let options = a;
                    let callback = b;
                    if ('function' == typeof a) [options, callback] = [
                ...
                this.copyFile = (src, dest, a, b)=>{
                    ...
                    let flags;
                    let callback;
                    if ('function' == typeof a) [flags, callback] = [
                        0,
                        a
                    ];
                    else [flags, callback] = [
                ...
                this.symlink = (target, path, a, b)=>{
                    const callback = (0, util_3.validateCallback)('function' == typeof a ? a : b);
                    const targetFilename = (0, util_3.pathToFilename)(target);
                    const pathFilename = (0, util_3.pathToFilename)(path);
                ...
                this.access = (path, a, b)=>{
                    let mode = F_OK;
                    let callback;
                    if ('function' != typeof a) [mode, callback] = [
                        0 | a,
                ...
                this._readdir = (filename, options)=>{
                    ...
                    if (!util_1.isWin && 'buffer' !== options.encoding) list.sort((a, b)=>{
                ...
                this.ftruncate = (fd, a, b)=>{
                    const len = 'number' == typeof a ? a : 0;
                    const callback = (0, util_3.validateCallback)('number' == typeof a ? b : a);
                ...
                this._futimes = (fd, atime, mtime)=>{
                    ...
                    node.atime = new Date(1000 * atime);
                    node.mtime = new Date(1000 * mtime);
                };
                ...
                this.mkdtempSync = (prefix, options)=>{
                    ...
                    if (!prefix || 'string' != typeof prefix) throw new TypeError('filename prefix is required');
                ...
                this.openAsBlob = async (path, options)=>{
                    ...
                    try {
                        ...
                        if (error && 'object' == typeof error && 'ENOENT' === error.code) {
                ...
                this.glob = (pattern, ...args)=>{
                    const [options, callback] = 1 === args.length ? [
                        {},
                        args[0]
                    ] : [
                        args[0],
            ...
            cpDirSync(srcStat, destStat, src, dest, options) {
                ...
                for (const entry of entries){
                    ...
                    if (!options.filter || options.filter(srcItem, destItem)) this._cp(srcItem, destItem, options);
                }
                this.chmodSync(dest, Number(srcStat.mode));
            }
            ...
            _stat(filename, bigint = false, throwIfNoEntry = true) {
                ...
                if ("ENOENT" === result.err.code && !throwIfNoEntry) return (0, fs_core_1.Ok)(void 0);
                return result;
            }
            ...
            watchFile(path, a, b) {
                ...
                if ('function' != typeof listener) throw Error('"watchFile()" requires a listener function');
                let interval = 5007;
                let persistent = true;
                if (options && 'object' == typeof options) {
                    if ('number' == typeof options.interval) interval = options.interval;
                    if ('boolean' == typeof options.persistent) persistent = options.persistent;
                }
            ...
            unwatchFile(path, listener) {
                ...
                if (!watcher) return;
                if ('function' == typeof listener) watcher.removeListener('change', listener);
                else watcher.removeAllListeners('change');
                if (0 === watcher.listenerCount('change')) {
                    watcher.stop();
            ...
            watch(path, options, listener) {
                ...
                if (void 0 === persistent) persistent = true;
        ...
        class StatWatcher extends events_1.EventEmitter {
            ...
            start(path, persistent = true, interval = 5007) {
                ...
                this.setTimeout = persistent ? setTimeout.bind("u" > typeof globalThis ? globalThis : global) : setTimeoutUnref_1.default;
        ...
        function FsReadStream(vol, path, options) {
            ...
            if ('number' != typeof this.fd) this.open();
        ...
        FsReadStream.prototype._read = function(n) {
            ...
            var start = pool.used;
            if (void 0 !== this.pos) toRead = Math.min(this.end - this.pos + 1, toRead);
            if (toRead <= 0) return this.push(null);
            var self = this;
            this._vol.read(this.fd, pool, pool.used, toRead, this.pos, onread);
            if (void 0 !== this.pos) this.pos += toRead;
            pool.used += toRead;
        ...
        FsReadStream.prototype.close = function(cb) {
            ...
            if (this.closed || 'number' != typeof this.fd) {
                if ('number' != typeof this.fd) return void this.once('open', closeOnOpen);
        ...
        FsWriteStream.prototype._write = function(data, encoding, cb) {
            ...
            if (void 0 !== this.pos) this.pos += data.length;
        };
        FsWriteStream.prototype._writev = function(data, cb) {
            ...
            if (void 0 !== this.pos) this.pos += size;
        };
        ...
        class FSWatcher extends events_1.EventEmitter {
            constructor(vol){
                ...
                this._onParentChild = (link)=>{
                    if (link.getName() === this._getName()) this._emit('rename');
                };
                this._emit = (type)=>{
                ...
                const watchLinkChildrenChanged = (link)=>{
                    ...
                    const onLinkChildDelete = (l)=>{
                        const removeLinkNodeListeners = (curLink)=>{
                            ...
                            for (const [name, childLink] of curLink.children.entries())if (childLink && '.' !== name && '..' !== name) removeLinkNodeListeners(childLink);
                        };
                        removeLinkNodeListeners(l);
                        this.emit('change', 'rename', pathRelative(this._filename, l.getPath()));
                    };
                    for (const [name, childLink] of link.children.entries())if (childLink && '.' !== name && '..' !== name) watchLinkNodeChanged(childLink);
                    const unsubscribeLinkChanges = link.changes.listen(([type, link])=>{
                        if ('child:add' === type) onLinkChildAdd(link);
                        else if ('child:del' === type) onLinkChildDelete(link);
                    });
                    const removers = this._listenerRemovers.get(node.ino) ?? [];
                    removers.push(()=>{
                    ...
                    if (recursive) {
                        for (const [name, childLink] of link.children.entries())if (childLink && '.' !== name && '..' !== name) watchLinkChildrenChanged(childLink);
                    }
                };
                watchLinkNodeChanged(this._link);
                watchLinkChildrenChanged(this._link);
                const parent = this._link.parent;
                if (parent) parent.changes.listen(([type, link])=>{
                    if ('child:del' === type) this._onParentChild(link);
                });
        ...
        const toTreeSync = (fs, opts = {})=>{
            ...
            if (depth > 0) {
                ...
                subtree = (0, tree_dump_1.printTree)(tab, list.map((entry)=>(tab)=>{
                        ...
                        if (entry.isSymbolicLink()) return '' + entry.name + ' → ' + fs.readlinkSync(dir + entry.name);
                        return '' + entry.name;
                    }));
            }
                ...
                case 0:
                    {
                        ...
                        for (const [name, child] of Object.entries(entries))await (0, exports.fromSnapshot)(child, {
                            fs,
                            path: `${path}${name}`,
                            separator
                        });
                ...
                case 0:
                    {
                        ...
                        for (const [name, child] of Object.entries(entries))(0, exports.fromSnapshotSync)(child, {
                            fs,
                            path: `${path}${name}`,
                            separator
                        });
    ...
    "./node_modules/.pnpm/@jsonjoy.com+json-pack@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/json-pack/lib/cbor/CborDecoder.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        const CborDecoderBase_1 = __webpack_require__("./node_modules/.pnpm/@jsonjoy.com+json-pack@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/json-pack/lib/cbor/CborDecoderBase.js");
        const JsonPackValue_1 = __webpack_require__("./node_modules/.pnpm/@jsonjoy.com+json-pack@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/json-pack/lib/JsonPackValue.js");
        class CborDecoder extends CborDecoderBase_1.CborDecoderBase {
            readAsMap() {
                const octet = this.reader.u8();
                const major = octet >> 5;
                const minor = 31 & octet;
                switch(major){
                    case 5:
            ...
            skipBin(minor) {
                ...
                if (length >= 0) this.reader.skip(length);
                    ...
                    while(255 !== this.reader.peak())this.skipBinChunk();
                    this.reader.x++;
                }
            }
            skipBinChunk() {
            ...
            skipStr(minor) {
                ...
                if (length >= 0) this.reader.skip(length);
                    ...
                    while(255 !== this.reader.peak())this.skipStrChunk();
                    this.reader.x++;
                }
            }
            skipStrChunk() {
            ...
            skipArr(minor) {
                ...
                if (length >= 0) this.skipN(length);
                    ...
                    while(255 !== this.reader.peak())this.skipAny();
                    this.reader.x++;
                }
            }
            skipObj(minor) {
            ...
            readArrIndefLevel() {
                const arr = [];
                while(255 !== this.reader.peak())arr.push(this.readPrimitiveOrVal());
                this.reader.x++;
                return arr;
            }
            readHdr(expectedMajor) {
                const octet = this.reader.u8();
                const major = octet >> 5;
                if (major !== expectedMajor) throw 0;
                const minor = 31 & octet;
            ...
            find(path) {
                for(let i = 0; i < path.length; i++){
                    ...
                    if ('string' == typeof segment) this.findKey(segment);
    ...
    "./node_modules/.pnpm/@jsonjoy.com+json-pack@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/json-pack/lib/cbor/CborDecoderBase.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        const tslib_1 = __webpack_require__("./node_modules/.pnpm/tslib@2.8.1/node_modules/tslib/tslib.es6.mjs");
        const f16_1 = __webpack_require__("./node_modules/.pnpm/@jsonjoy.com+buffers@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/buffers/lib/f16.js");
        const JsonPackExtension_1 = __webpack_require__("./node_modules/.pnpm/@jsonjoy.com+json-pack@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/json-pack/lib/JsonPackExtension.js");
        const JsonPackValue_1 = __webpack_require__("./node_modules/.pnpm/@jsonjoy.com+json-pack@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/json-pack/lib/JsonPackValue.js");
        ...
        const sharedCachedUtf8Decoder_1 = tslib_1.__importDefault(__webpack_require__("./node_modules/.pnpm/@jsonjoy.com+buffers@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/buffers/lib/utf8/sharedCachedUtf8Decoder.js"));
        class CborDecoderBase {
            ...
            readAny() {
                ...
                if (major < 6) return 4 === major ? this.readArr(minor) : this.readObj(minor);
                return 6 === major ? this.readTag(minor) : this.readTkn(minor);
            }
            readAnyRaw(octet) {
                const major = octet >> 5;
                const minor = 31 & octet;
            ...
            readStr(minor) {
                ...
                switch(minor){
                    ...
                    case 31:
                        {
                            let str = '';
                            while(255 !== reader.peak())str += this.readStrChunk();
                            this.reader.x++;
                            return str;
                        }
                    default:
            ...
            readArrIndef() {
                const arr = [];
                while(255 !== this.reader.peak())arr.push(this.readAny());
                this.reader.x++;
                return arr;
            }
            readObj(minor) {
            ...
            key() {
                ...
                const major = octet >> 5;
                const minor = 31 & octet;
                if (3 !== major) return String(this.readAnyRaw(octet));
    ...
    "./node_modules/.pnpm/@jsonjoy.com+json-pack@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/json-pack/lib/cbor/CborEncoder.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        const isFloat32_1 = __webpack_require__("./node_modules/.pnpm/@jsonjoy.com+buffers@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/buffers/lib/isFloat32.js");
        const JsonPackExtension_1 = __webpack_require__("./node_modules/.pnpm/@jsonjoy.com+json-pack@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/json-pack/lib/JsonPackExtension.js");
        const CborEncoderFast_1 = __webpack_require__("./node_modules/.pnpm/@jsonjoy.com+json-pack@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/json-pack/lib/cbor/CborEncoderFast.js");
        const JsonPackValue_1 = __webpack_require__("./node_modules/.pnpm/@jsonjoy.com+json-pack@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/json-pack/lib/JsonPackValue.js");
        class CborEncoder extends CborEncoderFast_1.CborEncoderFast {
            ...
            writeFloat(float) {
                if ((0, isFloat32_1.isFloat32)(float)) this.writer.u8f32(0xfa, float);
    ...
    "./node_modules/.pnpm/@jsonjoy.com+json-pack@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/json-pack/lib/cbor/CborEncoderFast.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        class CborEncoderFast {
            ...
            writeNumber(num) {
                ...
                else if ('bigint' == typeof num) this.writeBigInt(num);
            ...
            writeBinHdr(length) {
                ...
                else if (length <= 0xff) writer.u16(22528 + length);
            ...
            writeStrHdr(length) {
                ...
                else if (length <= 0xff) writer.u16(30720 + length);
            ...
            writeArrHdr(length) {
                ...
                else if (length <= 0xff) writer.u16(38912 + length);
            ...
            writeObjHdr(length) {
                ...
                else if (length <= 0xff) writer.u16(47104 + length);
            ...
            writeTagHdr(tag) {
                ...
                else if (tag <= 0xff) writer.u16(55296 + tag);
            ...
            writeTkn(value) {
                ...
                else if (value <= 0xff) writer.u16(63488 + value);
            }
            writeStartStr() {
                this.writer.u8(0x7f);
            }
    ...
    "./node_modules/.pnpm/@jsonjoy.com+json-pack@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/json-pack/lib/json/JsonDecoder.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        const util_1 = __webpack_require__("./node_modules/.pnpm/@jsonjoy.com+json-pack@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/json-pack/lib/json/util.js");
        ...
        const hasBinaryPrefix = (u8, x)=>0x64 === u8[x] && 0x61 === u8[x + 1] && 0x74 === u8[x + 2] && 0x61 === u8[x + 3] && 0x3a === u8[x + 4] && 0x61 === u8[x + 5] && 0x70 === u8[x + 6] && 0x70 === u8[x + 7] && 0x6c === u8[x + 8] && 0x69 === u8[x + 9] && 0x63 === u8[x + 10] && 0x61 === u8[x + 11] && 0x74 === u8[x + 12] && 0x69 === u8[x + 13] && 0x6f === u8[x + 14] && 0x6e === u8[x + 15] && 0x2f === u8[x + 16] && 0x6f === u8[x + 17] && 0x63 === u8[x + 18] && 0x74 === u8[x + 19] && 0x65 === u8[x + 20] && 0x74 === u8[x + 21] && 0x2d === u8[x + 22] && 0x73 === u8[x + 23] && 0x74 === u8[x + 24] && 0x72 === u8[x + 25] && 0x65 === u8[x + 26] && 0x61 === u8[x + 27] && 0x6d === u8[x + 28] && 0x3b === u8[x + 29] && 0x62 === u8[x + 30] && 0x61 === u8[x + 31] && 0x73 === u8[x + 32] && 0x65 === u8[x + 33] && 0x36 === u8[x + 34] && 0x34 === u8[x + 35] && 0x2c === u8[x + 36];
        const isUndefined = (u8, x)=>0x61 === u8[x++] && 0x74 === u8[x++] && 0x61 === u8[x++] && 0x3a === u8[x++] && 0x61 === u8[x++] && 0x70 === u8[x++] && 0x70 === u8[x++] && 0x6c === u8[x++] && 0x69 === u8[x++] && 0x63 === u8[x++] && 0x61 === u8[x++] && 0x74 === u8[x++] && 0x69 === u8[x++] && 0x6f === u8[x++] && 0x6e === u8[x++] && 0x2f === u8[x++] && 0x63 === u8[x++] && 0x62 === u8[x++] && 0x6f === u8[x++] && 0x72 === u8[x++] && 0x2c === u8[x++] && 0x62 === u8[x++] && 0x61 === u8[x++] && 0x73 === u8[x++] && 0x65 === u8[x++] && 0x36 === u8[x++] && 0x34 === u8[x++] && 0x3b === u8[x++] && 0x39 === u8[x++] && 0x77 === u8[x++] && 0x3d === u8[x++] && 0x3d === u8[x++] && 0x22 === u8[x++];
        const fromCharCode = String.fromCharCode;
        const readKey = (reader)=>{
            ...
            while(x < len){
                ...
                if ((0x80 & code) === 0) if (92 === prev) {
                    ...
                    const octet2 = 0x3f & buf[x++];
                    if ((0xe0 & code) === 0xc0) code = (0x1f & code) << 6 | octet2;
                    else {
                        const octet3 = 0x3f & buf[x++];
                        if ((0xf0 & code) === 0xe0) code = (0x1f & code) << 12 | octet2 << 6 | octet3;
                        else if ((0xf8 & code) === 0xf0) {
                            const octet4 = 0x3f & buf[x++];
                            let unit = (0x07 & code) << 0x12 | octet2 << 0x0c | octet3 << 0x06 | octet4;
                            if (unit > 0xffff) {
                                unit -= 0x10000;
                                const unit0 = unit >>> 10 & 0x3ff | 0xd800;
        ...
        class JsonDecoder {
            ...
            readNull() {
                if (0x6e756c6c !== this.reader.u32()) throw new Error('Invalid JSON');
                return null;
            }
            readTrue() {
                if (0x74727565 !== this.reader.u32()) throw new Error('Invalid JSON');
                return true;
            }
            readFalse() {
                const reader = this.reader;
                if (0x66 !== reader.u8() || 0x616c7365 !== reader.u32()) throw new Error('Invalid JSON');
                return false;
            }
            readBool() {
                const reader = this.reader;
            ...
            readNum() {
                ...
                const c1 = c;
                c = uint8[x++];
                if (!c || (c < 45 || c > 57) && 43 !== c && 69 !== c && 101 !== c) {
                    reader.x = x - 1;
            ...
            readBin() {
                ...
                const u8 = reader.uint8;
                let x = reader.x;
                if (0x22 !== u8[x++]) throw new Error('Invalid JSON');
                const hasDataUrlPrefix = hasBinaryPrefix(u8, x);
            ...
            readArr() {
                const reader = this.reader;
                if (0x5b !== reader.u8()) throw new Error('Invalid JSON');
                const arr = [];
                const uint8 = reader.uint8;
                let first = true;
                while(true){
            ...
            readObj() {
                const reader = this.reader;
                if (0x7b !== reader.u8()) throw new Error('Invalid JSON');
                const obj = {};
                const uint8 = reader.uint8;
                let first = true;
                while(true){
    ...
    "./node_modules/.pnpm/@jsonjoy.com+json-pack@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/json-pack/lib/json/JsonEncoder.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        const toBase64Bin_1 = __webpack_require__("./node_modules/.pnpm/@jsonjoy.com+base64@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/base64/lib/toBase64Bin.js");
        class JsonEncoder {
            constructor(writer){
                this.writer = writer;
            }
            ...
            writeBoolean(bool) {
                if (bool) this.writer.u32(0x74727565);
                else this.writer.u8u32(0x66, 0x616c7365);
            }
            writeNumber(num) {
            ...
            writeStr(str) {
                const writer = this.writer;
                const length = str.length;
                writer.ensureCapacity(4 * length + 2);
                if (length < 256) {
                    ...
                    for(let i = 0; i < length; i++){
                        ...
                        if (code < 32 || code > 126) {
                            ...
                            writer.ensureCapacity(4 * jsonStr.length + 4);
                            writer.utf8(jsonStr);
                            return;
                        }
                        uint8[x++] = code;
    ...
    "./node_modules/.pnpm/@jsonjoy.com+json-pack@17.67.0_tslib@2.8.1/node_modules/@jsonjoy.com/json-pack/lib/json/util.js" (__unused_rspack_module, exports) {
        ...
        const findEndingQuote = (uint8, x)=>{
            ...
            let prev = 0;
            while(x < len){
                if (34 === char && 92 !== prev) break;
                prev = 92 === char && 92 === prev ? 0 : char;
                char = uint8[++x];
            }
 ...
 */ module.exports = first;
    ...
    "./node_modules/.pnpm/memfs@4.57.2_tslib@2.8.1/node_modules/memfs/lib/index.js" (module, exports, __webpack_require__) {
        ...
        function createFsFromVolume(vol) {
            ...
            for (const method of fs_node_1.fsSynchronousApiList)if ('function' == typeof vol[method]) fs[method] = vol[method].bind(vol);
            for (const method of fs_node_1.fsCallbackApiList)if ('function' == typeof vol[method]) fs[method] = vol[method].bind(vol);
            fs.StatWatcher = vol.StatWatcher;
            fs.FSWatcher = vol.FSWatcher;
            fs.WriteStream = vol.WriteStream;
            fs.ReadStream = vol.ReadStream;
            fs.promises = vol.promises;
            if ('function' == typeof vol.realpath) {
                fs.realpath = vol.realpath.bind(vol);
                if ('function' == typeof vol.realpath.native) fs.realpath.native = vol.realpath.native.bind(vol);
            }
            if ('function' == typeof vol.realpathSync) {
                fs.realpathSync = vol.realpathSync.bind(vol);
                if ('function' == typeof vol.realpathSync.native) fs.realpathSync.native = vol.realpathSync.native.bind(vol);
            }
 ...
 */ module.exports = rangeParser;
    ...
    "./node_modules/.pnpm/tree-dump@1.1.0_tslib@2.8.1/node_modules/tree-dump/lib/index.js" (__unused_rspack_module, exports, __webpack_require__) {
        ...
        const tslib_1 = __webpack_require__("./node_modules/.pnpm/tslib@2.8.1/node_modules/tslib/tslib.es6.mjs");
        tslib_1.__exportStar(__webpack_require__("./node_modules/.pnpm/tree-dump@1.1.0_tslib@2.8.1/node_modules/tree-dump/lib/printTree.js"), exports);
        tslib_1.__exportStar(__webpack_require__("./node_modules/.pnpm/tree-dump@1.1.0_tslib@2.8.1/node_modules/tree-dump/lib/printBinary.js"), exports);
        tslib_1.__exportStar(__webpack_require__("./node_modules/.pnpm/tree-dump@1.1.0_tslib@2.8.1/node_modules/tree-dump/lib/printJson.js"), exports);
    },
...
function getRequestHeader(req, name) {
    if ("function" == typeof req.getHeader) return req.getHeader(name);
    return req.headers[name];
}
function getRequestMethod(req) {
    if ("function" == typeof req.getMethod) return req.getMethod();
    return req.method;
}
...
function setStatusCode(res, code) {
    if ("function" == typeof res.setStatusCode) return void res.setStatusCode(code);
    res.statusCode = code;
}
function getStatusCode(res) {
    if ("function" == typeof res.getStatusCode) return res.getStatusCode();
...
function getResponseHeaders(res) {
    if ("function" == typeof res.getResponseHeaders) return res.getResponseHeaders();
    return res.getHeaderNames();
}
function getHeadersSent(res) {
    if ("function" == typeof res.getHeadersSent) return res.getHeadersSent();
    return res.headersSent;
}
function pipe(res, bufferOrStream) {
    if ("function" == typeof res.stream) return void res.stream(bufferOrStream);
    bufferOrStream.pipe(res);
}
function send(res, bufferOrString) {
    if ("function" == typeof res.send) return void res.send(bufferOrString);
    res.end(bufferOrString);
}
function finish(res, data) {
    if ("function" == typeof res.finish) return void res.finish(data);
    res.end(data);
}
function createReadStreamOrReadFileSync(filename, outputFileSystem, start, end) {
    let bufferOrStream;
    let byteLength;
    const isFsSupportsStream = "function" == typeof outputFileSystem.createReadStream;
...
function getOutgoing(res) {
    if ("function" == typeof res.getOutgoing) return res.getOutgoing();
    return res;
}
function initState(res) {
    if ("function" == typeof res.setState) return;
    res.locals ||= {};
}
function setState(res, name, value) {
    if ("function" == typeof res.setState) return void res.setState(name, value);
...
async function etag_etag(entity) {
    const isStrong = Buffer.isBuffer(entity) || "function" == typeof entity.pipe;
    return isStrong ? entityTag(entity) : statTag(entity);
}
const utils_etag = etag_etag;
const matchHtmlRegExp = /["'&<>]/;
function escapeHtml_escapeHtml(string) {
    const str = `${string}`;
...
const utils_escapeHtml = escapeHtml_escapeHtml;
function getPaths(context) {
    const { stats, options } = context;
    const childStats = stats.stats ? stats.stats : [
        stats
    ];
    const publicPaths = [];
...
function parseTokenList(str) {
    ...
    for(let i = 0, len = str.length; i < len; i++)switch(str.charCodeAt(i)){
        case 0x20:
            ...
            break;
        case 0x2c:
            if (start !== end) list.push(str.slice(start, end));
            end = i + 1;
            start = end;
            break;
        default:
...
const utils_parseTokenList = parseTokenList;
function ready(context, callback, req) {
    if (context.state) return void callback(context.stats);
    const name = req && req.url || callback.name;
    context.logger.info(`wait until bundle finished${name ? `: ${name}` : ""}`);
    context.callbacks.push(callback);
}
const utils_ready = ready;
const on_finished = __webpack_require__("./node_modules/.pnpm/on-finished@2.4.1/node_modules/on-finished/index.js");
const range_parser = __webpack_require__("./node_modules/.pnpm/range-parser@1.2.1/node_modules/range-parser/index.js");
...
function getContentType(filename) {
    ...
    if (mimeType.startsWith("text/") || UTF8_CHARSET_MIME_TYPES.has(mimeType)) return `${mimeType}; charset=utf-8`;
    return mimeType;
}
...
function destroyStream(stream, suppress) {
    ...
    if ("function" == typeof stream.close) stream.on("open", function() {
        if ("number" == typeof this.fd) this.close();
    });
    if ("function" == typeof stream.addListener && suppress) {
...
const parseRangeHeaders = utils_memorize((value)=>{
    const [len, rangeHeader] = value.split("|");
    return range_parser(Number(len), rangeHeader, {
        combine: true
    });
});
const getETag = utils_memorize(()=>utils_etag);
const getEscapeHtml = utils_memorize(()=>utils_escapeHtml);
const getParseTokenList = utils_memorize(()=>utils_parseTokenList);
const MAX_MAX_AGE = 31536000000;
function wrapper(context) {
    return async function(req, res, next) {
        async function goNext(err) {
            if (!context.options.serverSideRender) return next(err);
        ...
        if (method && !acceptedMethods.includes(method)) return void await goNext();
...
<pre>${escapeHtml(content)}</pre>
            ...
            for(let i = 0; i < headers.length; i++)removeResponseHeader(res, headers[i]);
            if (options && options.headers) {
                const keys = Object.keys(options.headers);
                for(let i = 0; i < keys.length; i++){
                    const key = keys[i];
                    const value = options.headers[key];
                    if (void 0 !== value) setResponseHeader(res, key, value);
                }
            }
            ...
            if (options && options.modifyResponseData) ({ data: document, byteLength } = options.modifyResponseData(req, res, document, byteLength));
        ...
        function isPreconditionFailure() {
            ...
            const ifUnmodifiedSince = getRequestHeader(req, "if-unmodified-since");
        ...
        function isCachable() {
            ...
            return statusCode >= 200 && statusCode < 300 || 304 === statusCode || 404 === statusCode;
        }
        function isFresh(resHeaders) {
            const cacheControl = getRequestHeader(req, "cache-control");
            if (cacheControl && CACHE_CONTROL_NO_CACHE_REGEXP.test(cacheControl)) return false;
            const noneMatch = getRequestHeader(req, "if-none-match");
            const modifiedSince = getRequestHeader(req, "if-modified-since");
            if (!noneMatch && !modifiedSince) return false;
            if (noneMatch && "*" !== noneMatch) {
                if (!resHeaders.etag) return false;
        ...
        function isRangeFresh() {
            ...
            const lastModified = getResponseHeader(res, "Last-Modified");
        ...
        async function processRequest() {
            ...
            if (context.options.headers) {
                ...
                if ("function" == typeof headers) headers = headers(req, res, context);
                const allHeaders = [];
                if (void 0 !== headers) {
                    ...
                    for (const { key, value } of headers)setResponseHeader(res, key, value);
                }
            }
            ...
            if (context.options.etag && !getResponseHeader(res, "ETag")) {
                const isStrongETag = "strong" === context.options.etag;
                if (isStrongETag) {
                    if (rangeHeader) {
                        const parsedRanges = parseRangeHeaders(`${size}|${rangeHeader}`);
                        if (-2 !== parsedRanges && -1 !== parsedRanges && 1 === parsedRanges.length) [offset, len] = getOffsetAndLenFromRange(parsedRanges[0]);
                    }
                ...
                const result = await getETag()(isStrongETag ? bufferOrStream : extra.stats);
                if (result.buffer) bufferOrStream = result.buffer;
                setResponseHeader(res, "ETag", result.hash);
            }
            if (!getResponseHeader(res, "Content-Type") || 404 === getStatusCode(res)) {
                removeResponseHeader(res, "Content-Type");
                const contentType = getContentType(node_path.extname(filename));
                if (contentType) setResponseHeader(res, "Content-Type", contentType);
                else if (context.options.mimeTypeDefault) setResponseHeader(res, "Content-Type", context.options.mimeTypeDefault);
            }
            if (isConditionalGET()) {
                if (isPreconditionFailure()) return void await sendError("Precondition Failed", 412, {
                    modifyResponseData: context.options.modifyResponseData
                });
            ...
            if (rangeHeader) {
                ...
                if (-2 === parsedRanges) context.logger.error("A malformed 'Range' header was provided. A regular response will be sent for this request.");
                else if (parsedRanges.length > 1) context.logger.error("A 'Range' header with multiple ranges was provided. Multiple ranges are not supported, so a regular response will be sent for this request.");
                if (-2 !== parsedRanges && 1 === parsedRanges.length) {
            ...
            if (context.options.modifyResponseData) ({ data: bufferOrStream, byteLength } = context.options.modifyResponseData(req, res, bufferOrStream, byteLength));
            setResponseHeader(res, "Content-Length", byteLength);
            if ("HEAD" === method) {
                if (!isPartialContent) setStatusCode(res, 200);
                finish(res);
                return;
            }
            if (!isPartialContent) setStatusCode(res, 200);
            const isPipeSupports = "function" == typeof bufferOrStream.pipe;
            if (!isPipeSupports) return void send(res, bufferOrStream);
            const cleanup = ()=>{
            ...
            if (outgoing) on_finished(outgoing, cleanup);
        }
        utils_ready(context, processRequest, req);
    };
}
const src_middleware = wrapper;
function setupHooks(context) {
    function invalid() {
        if (context.state) context.logger.log("Compilation starting...");
        context.state = false;
        context.stats = void 0;
    }
    function done(stats) {
        context.state = true;
        context.stats = stats;
        process.nextTick(()=>{
            ...
            let statsOptions;
            statsOptions = void 0 !== options.stats ? isMultiCompilerMode ? {
                children: compiler.compilers.map(()=>options.stats)
            } : options.stats : isMultiCompilerMode ? {
                children: compiler.compilers.map((child)=>child.options.stats)
            } : compiler.options.stats;
            const printedStats = stats.toString(statsOptions);
            if (printedStats) console.log(printedStats);
            context.callbacks = [];
            for (const callback of callbacks)callback(stats);
        });
    }
...
function setupOutputFileSystem(context) {
    ...
    } else if (true !== context.options.writeToDisk) {
        const candidateOutputFileSystem = memfs_lib.createFsFromVolume(new memfs_lib.Volume());
        if (candidateOutputFileSystem && "function" == typeof candidateOutputFileSystem.readFileSync && "function" == typeof candidateOutputFileSystem.statSync) outputFileSystem = candidateOutputFileSystem;
        else {
            outputFileSystem = (0, memfs_lib.createFsFromVolume)(new memfs_lib.Volume());
            if (candidateOutputFileSystem) Object.assign(outputFileSystem, candidateOutputFileSystem);
        }
    } else {
        const isMultiCompiler = context.compiler.compilers;
        if (isMultiCompiler) {
            const compiler = context.compiler.compilers.find((item)=>Object.hasOwn(item.options, "devServer") && false !== item.options.devServer);
            ({ outputFileSystem } = compiler || context.compiler.compilers[0]);
        } else ({ outputFileSystem } = context.compiler);
    }
    const compilers = context.compiler.compilers || [
        context.compiler
    ];
    for (const compiler of compilers)if (false !== compiler.options.devServer) compiler.outputFileSystem = outputFileSystem;
    context.outputFileSystem = outputFileSystem;
}
const utils_setupOutputFileSystem = setupOutputFileSystem;
const ASSET_EMITTED_CALLBACK_FLAG = "hasRspackDevMiddlewareAssetEmittedCallback";
function setupWriteToDisk(context) {
    const compilers = context.compiler.compilers || [
        context.compiler
    ];
    for (const compiler of compilers)if (false !== compiler.options.devServer) compiler.hooks.emit.tap("DevMiddleware", ()=>{
        if (compiler[ASSET_EMITTED_CALLBACK_FLAG]) return;
        compiler.hooks.assetEmitted.tapAsync("DevMiddleware", (file, info, callback)=>{
            const { targetPath, content } = info;
            const { writeToDisk: filter } = context.options;
            const allowWrite = filter && "function" == typeof filter ? filter(targetPath) : true;
            if (!allowWrite) return callback();
            const dir = node_path.dirname(targetPath);
            const name = compiler.options.name ? `Child "${compiler.options.name}": ` : "";
            return node_fs.mkdir(dir, {
                recursive: true
            }, (mkdirError)=>{
                if (mkdirError) {
                ...
                return node_fs.writeFile(targetPath, content, (writeFileError)=>{
                    if (writeFileError) {
...
const utils_setupWriteToDisk = setupWriteToDisk;
const noop = ()=>{};
function rdm(compiler, options = {}) {
    const { mimeTypes } = options;
    if (mimeTypes) for (const [extension, type] of Object.entries(mimeTypes))mimes[extension.toLowerCase()] = type;
    const context = {
        state: false,
        stats: void 0,
        callbacks: [],
    ...
    utils_setupHooks(context);
    if ("function" == typeof options.writeToDisk) utils_setupWriteToDisk(context);
    utils_setupOutputFileSystem(context);
    if (context.compiler.watching) context.watching = context.compiler.watching;
    else {
        const errorHandler = (error)=>{
            if (error) context.logger.error(error);
        };
        if (Array.isArray(context.compiler.compilers)) {
            const compilers = context.compiler;
            ...
            const oneCompiler = context.compiler;
...
function hapiWrapper() {
    return {
        ...
        register (server, options) {
            ...
            if (!server.decorations.server.includes("rspackDevMiddleware")) server.decorate("server", "rspackDevMiddleware", devMiddleware);
    ...
    async function rspackDevMiddleware(context, next) {
        ...
        try {
            await new Promise((resolve, reject)=>{
                ...
                res.finish = (data)=>{
                    const isDataExist = void 0 !== data;
                    if (isDataExist) context.res.headers.delete("Content-Length");
        ...
        if (void 0 !== body) return context.body(body, status);
        await next();
    }
    rspackDevMiddleware.devMiddleware = devMiddleware;
    return rspackDevMiddleware;
...
const src_devMiddleware = rdm;
export { src_devMiddleware as devMiddleware };
