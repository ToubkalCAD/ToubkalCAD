...
const { EVALUATORS, resolveBlendEdges } = await import(`${OUT}/services/FeatureEvaluators.js`);
const { captureEdge, captureEdges, resolveEdge } = await import(`${OUT}/services/StableRef.js`);
